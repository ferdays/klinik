...
<body id='fitur'>
	...
	<div id='kanan'>
		<a href='lihatbaru.php'><font class='k' style='color:#2C3E50;margin-top:20px;margin-left:20px;display:inline-block;'>Pasien Baru</font></a><a href='lihatlama.php'><font class='k' style='color:white;margin-top:20px;margin-left:50px;display:inline-block;'>Pasien Lama</font></a><br>
		<br>
<?php
require_once('../koneksi.php');
$query1="select * from databaru where type='baru'";
$result=mysql_query($query1) or die(mysql_error());
while($rows=mysql_fetch_object($result)){
      ?>
		<div class='lihat'>
			<font class='sk' style='margin-left:20px;margin-top:5px;display:inline-block;color:#f39c12;'>Nama: <font class='sk'><?php echo $rows -> nama; ?></font></font><br>
			...
			<font class='sk' style='margin-left:20px;margin-top:5px;display:inline-block;color:#f39c12;'>Jenis Kelamin: <font class='sk'><?php echo $rows -> jeniskelamin; ?></font></font><br>
			...
			<font class='sk' style='margin-left:20px;margin-top:5px;display:inline-block;color:#f39c12;'>Penyakit Sebelum: <font class='sk'><?php echo $rows -> penyakitsebelum; ?></font></font><br>
			<font class='sk' style='margin-left:20px;margin-top:5px;display:inline-block;color:#f39c12;'>Golongan Darah: <font class='sk'><?php echo $rows -> golongandarah; ?></font></font><br>
			<div id='edit'>
