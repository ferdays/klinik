...
<body id='fitur'>
	...
	<div id='kanan'>
		<a href='lihatbaru.php'><font class='k' style='color:white;margin-top:20px;margin-left:20px;display:inline-block;'>Dokter</font></a><br>
		<br>
<?php
require_once('../koneksi.php');
$query1="select * from datadokter ";
$result=mysql_query($query1) or die(mysql_error());
while($rows=mysql_fetch_object($result)){
      ?>
		<div class='lihat'>
			<font class='sk' style='margin-left:20px;margin-top:5px;display:inline-block;color:#f39c12;'>Username: <font class='sk'><?php echo $rows -> username; ?></font></font><br>
			<font class='sk' style='margin-left:20px;margin-top:5px;display:inline-block;color:#f39c12;'>Password: <font class='sk'><?php echo $rows -> password; ?></font></font><br>
			...
			<div id='edit'>
			<a href='edit.php?idpasien=<?php echo $rows -> id;?>' style='font-size:30px;'>Edit</a> <font class='s'>|</font> <a href='deletedokter.php?iddokter=<?php echo $rows -> id;?>' style='font-size:30px;'>Hapus</a>
			</div>
		</div>
