...
<html>
<head>
	<title>Klinik | Edit Panel User - Front Office</title>
...
<body>
	<div id='wrapper'>
		...
		<article>
			...
			<br><br>
			<div id='pasien'>
				<font class='k' style='color:white;display:inline-block;margin-top:10px;margin-left:10px;'>User Pasien</font><br>
				<center>
    				...
    				?>
                            <tr>
                                ...
                                <td><a href="editpanelpasien.php?idpasien=<?php echo $data['no'];?>">Edit</a> | <a href="deletepanelpasien.php?idpasien=<?php echo $data['no']; ?>">Delete</a></td>
                            </tr>
                            </tbody>
			...
			<div id='frontoffice'>
				<font class='k' style='color:white;display:inline-block;margin-top:10px;margin-left:10px;'>Edit User Frontoffice</font><br>
				<br>
