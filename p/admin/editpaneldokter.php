...
<html>
<head>
	<title>Klinik | Edit Panel User - Dokter</title>
...
<body>
	<div id='wrapper'>
		...
		<article>
			...
			<div id='dokter'>
				<font class='k' style='color:white;display:inline-block;margin-top:10px;margin-left:10px;'>Edit User Dokter</font><br>
				<br>
